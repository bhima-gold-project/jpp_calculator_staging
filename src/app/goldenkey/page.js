...
const GoldenKey = () => {
          ...
          <div className="bg-[#fffdf8] border border-[#f1e6cf] rounded-[26px] p-4">
            ...
            <div className="mt-5 rounded-[22px] bg-gradient-to-r from-[#fbf4e5] to-[#fff] border border-[#f2dfb5] p-4">
              ...
              <p className="mt-2 text-[12px] leading-6 text-[#666] font-work">
                Enjoy complete waiver on jewellery making charges.
              </p>
  ...
  //         <p className="font-quiche text-xl md:text-3xl text-[#b7892b] tracking-wide">
  //           Golden Key
  //         </p>
  //       </div> */}
  ...
  //                 No Making charges on Total Amount Paid i.e,<span className="font-bold text-[#b7892b] font-quiche">
  //                   {formatter.format(getTotal())}
  //                 </span> (Effectively you get benefit worth   <span className="ml-2 font-quiche font-bold text-green-600">
  //                   {formatter.format(getDiscount())}
  ...
  //           <p className="font-work text-sm text-gray-600">
  //             For more details contact
  //           </p>

  //           <a
  //             href="tel:1800-121-9076"
  //             className="font-arial text-sm font-bold text-[#b7892b]"
  //           >
  //             1800-121-9076
  //           </a>
